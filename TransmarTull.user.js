...
//q_79f34507-4242-e811-80d6-ee6c6c76c8f5
//q_86f34507-4242-e811-80d6-ee6c6c76c8f5
//q_64f34507-4242-e811-80d6-ee6c6c76c8f5
...
var answers = ["Transmar Ab","0144866-7","018-27011","trafikledning@transmar.fi","Clemes Mats","Åland-Finland"];
...
//     //btn.setAttribute("onclick","inputFields();");
//     btn.setAttribute("class","nextNavStyle");
//     btn.innerHTML = "Fyll i tabell";
//     li.appendChild(btn);
//     var bclass = document.getElementsByClassName("participation-buttons")[0];
//     console.log(bclass);
//     var children = bclass.childNodes[1].childNodes[1];
//     console.log(children);
//     bclass.childNodes[1].insertBefore(li,children);
//     button = btn;
//     button.addEventListener("onclick", inputFields());
//     // Your code here...
// }
...
document.addEventListener("keydown", function (e) {
    //var textArea = document.getElementsByClassName("textArea-2Spzkt scrollbarGhostHairline-1mSOM1 scrollbar-3dvm_9")[0];
    if(e.key == "MediaTrackPrevious"){
        console.log(nextbutton.childNodes[1]);
    }});